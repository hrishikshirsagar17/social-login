...
import com.zonions.dto.SocialProvider;
import com.zonions.exception.OAuth2AuthenticationProcessingException;
import com.zonions.exception.UserAlreadyExistAuthenticationException;
import com.zonions.model.Role;
import com.zonions.model.User;
import com.zonions.repository.RoleRepository;
import com.zonions.repository.UserRepository;
import com.zonions.security.oauth2.user.OAuth2UserInfo;
import com.zonions.security.oauth2.user.OAuth2UserInfoFactory;
...
public class UserServiceImpl implements UserService {
  ...
  public User changeRole(@PathVariable long id, @RequestBody User user) {

    Optional<User> restdata = userRepository.findById(id);

    User entity = new User(user.getId(), user.getProviderUserId(), user.getEmail(), true,
        user.getDisplayName(), user.getCreatedDate(), user.getModifiedDate(), user.getPassword(),
